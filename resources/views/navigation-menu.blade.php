                    ...
                    @auth
                        <x-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                ...
                                @if(Auth::user()->hasRole('GestorRRHH'))
                                    <x-dropdown-link href="{{ route('catalogo.trabajos') }}">
                                       Gestor RRHH
                                    </x-dropdown-link>
                               @endif
        ...
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    @endif
                    @if(Auth::user()->hasRole('GestorRRHH'))
                        <x-responsive-nav-link href="{{ route('catalogo.trabajos') }}" :active="request()->routeIs('catalogo.trabajos')">
                            Gestor RRHH
                        </x-responsive-nav-link>
                   @endif
